 ...
 * Jткрывает ссылку "Вконтакте" в новом окне для данного веб сайта.
 * Просиходит "подписка" в приложении "Вконтакте" в автоматическом режиме данного теста.
 * Закрытие вкладки "Вконтакте"
